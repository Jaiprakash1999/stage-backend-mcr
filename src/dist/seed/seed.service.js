        ...
        try {
            ...
            try {
                await this.tvShowModel.create([
                    {
                        title: 'Breaking Bad',
                        description: 'A high school chemistry teacher turned methamphetamine producer partners with a former student to create a lucrative meth lab.',
                    ...
                    },
                    {
                        ...
                        description: 'A woman who moves into an apartment across the hall from two brilliant but socially awkward physicists shows them how little they know about life outside of the lab.',
                        genres: ['Comedy', 'Romance'],
                        episodes: [
                            {
                                episodeNumber: 1,
